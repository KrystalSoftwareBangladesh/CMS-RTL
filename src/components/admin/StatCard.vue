...
<template>
  <BaseCard padding="lg" :hover="true">
    <div class="flex items-start justify-between">
      <div>
        ...
        >
          <svg v-if="changeType === 'positive'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
          </svg>
          <svg v-else-if="changeType === 'negative'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" :d="iconPaths[icon] || iconPaths.services" />
        </svg>
      </div>
    </div>
  </BaseCard>
